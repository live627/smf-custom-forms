...
add_integration_function('integrate_actions', 'CustomForms\\Integration::actions');
add_integration_function('integrate_menu_buttons', 'CustomForms\\Integration::buttons');
